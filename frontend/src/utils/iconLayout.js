...
export function iconCountBadgeClass(compact = false) {
  return `pointer-events-none absolute z-10 flex items-center justify-center rounded-full bg-neutral-900 font-bold leading-none text-white ring-2 ring-white ${
    compact

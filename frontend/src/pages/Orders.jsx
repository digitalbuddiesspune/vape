      ...
      <div className="mx-auto max-w-3xl lg:max-w-6xl">
        {authLoading || (user && loading && orders.length === 0 && !error) ? (
          ...
          <div className="pt-2 lg:pt-0">
            <StateCard className="lg:mx-auto lg:max-w-lg">
              <div className="text-center">
                <div className="mx-auto mb-4 flex h-[72px] w-[72px] items-center justify-center rounded-full bg-neutral-100 text-neutral-800">
                  <svg className="block h-9 w-9 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>

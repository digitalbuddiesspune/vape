...
function ProductShareMenu({ product, imageUrl, className = "" }) {
  ...
  return (
    <div className={`relative ${className}`} ref={menuRef}>
      <button
        ...
        disabled={sharing}
        className="inline-flex items-center gap-2 rounded-lg border border-border-light px-3 py-2 text-sm font-semibold text-text-primary transition hover:bg-mobile-surface disabled:opacity-50"
